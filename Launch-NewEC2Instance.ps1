...
# Get the latest AMI
$ImageID = (Get-SSMParameterValue -Name /aws/service/ami-windows-latest/Windows_Server-2016-English-Full-Base).Parameters[0].Value
# Creating Instance
$EC2Instance = New-EC2Instance -ImageId $imageid -MinCount 1 -MaxCount 1 -InstanceType t2.micro -KeyName ops-windows-sydney -SecurityGroupId $SecurityGroupID -Monitoring_Enabled $true -SubnetId $SubnetID01
# Tag the Instance
$Tag = New-Object Amazon.EC2.Model.Tag
#$Tag.Key = "Name"
#$Tag.Value = "MyVM"
